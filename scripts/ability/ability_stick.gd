...
const LUNGE_TIME = 1.75
const HURTBOX_TIME = 0.13
...
func _windup():
	...
	self.parent.movement.apply_speed(self.parent.movement.top_speed * WINDUP_TIME, MovementComponent.IGNORE_LOCK)
...
func _spawn_hurtbox():
	...
	hurtbox.despawn_after_delay(HURTBOX_TIME)
